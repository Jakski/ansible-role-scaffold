...
project = 'ansible-role-scaffold'
copyright = '2018, Jakub Pieńkowski'
...
htmlhelp_basename = 'ansible-role-scaffolddoc'
...
latex_documents = [
    (master_doc, 'ansible-role-scaffold.tex', '',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'ansible-role-scaffold', '',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ansible-role-scaffold', 'ansible-role-scaffold Documentation',
     author, 'ansible-role-scaffold', '',
     'Miscellaneous'),
]
